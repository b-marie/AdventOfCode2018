...
namespace AdventOfCode2018
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Challenge one result: {DayOnePartOne()}");
            Console.WriteLine($"Challenge two result: {DayOnePartTwo()}");
